...
export class SignUpPage extends Component {
    ...
    componentDidUpdate = () => {
        const {email, password, cf_password, username, isSubmitDisable} = this.state;
    ...
    render(){
        ...
        return (
            <div>
                ...
                {this.props.user.isRegistered ? <div>registered success!</div>:
                    <div className="sign-up__container">
                        <fieldset className="sign-up__fieldset">
                            <fieldset className="sign-up__fieldset__element">
                                <TextField name="username" type="text" placeholder="User Name" onChange={this.handleInputChange}/>
                            </fieldset>
                            <fieldset className="sign-up__fieldset__element">
                                <TextField name="email" type="email" placeholder="Email" onChange={this.handleInputChange}/>
                            </fieldset>
                            <fieldset className="sign-up__fieldset__element">
                                <TextField name="password" type="password" placeholder="Password" onChange={this.handleInputChange}/>
                            </fieldset>
                            <fieldset className="sign-up__fieldset__element">
                                <TextField name="cf_password" type="password" placeholder="Confirm Password" onChange={this.handleInputChange}/>
                            </fieldset>
                            <fieldset className="sign-up__fieldset__element">
                                <button disabled={isSubmitDisable} className={isSubmitDisable ? "sign-up__button sign-up__button-disable" : "sign-up__button"} onClick={this.submitSignUp}>Submit</button>
                            </fieldset>
                        </fieldset>
                    </div>}
                <CommonFooter />
